...
<meta name="viewport" content="width=device-width, initial-scale=1">
    ...
    <link rel="stylesheet" href="css/seatstyle.css" type="text/css" media="all">
...
<body onload="onLoaderFunc()">
        ...
        <div class="w3ls-reg">
           ...
           <form action="seatsel">
            <div class="displayerBoxes txt-center" style="overflow-x:auto;">
                <table class="table" style="width:50px; border:2px solid black; background-color: white; padding-right:2%" >
                    <tr >
                        <th>Name</th>
                    ...
                    <tr>
                        ...
                        <td>
                         ...
                         <td>
                            <textarea id="amountDisplay"></textarea>
                        </td>
                    </tr>
                </table>
            </div>
    ...
    <script>
        ...
        $(":checkbox").click(function () {
            if ($("input:checked").length == ($("#Numseats").val())) {
                $(":checkbox").prop('disabled', true);//.prop will take the property value for only the first elemnt in the matched set.
